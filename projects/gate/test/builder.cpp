#include <nil/gate/Builder.hpp>

#include <gmock/gmock.h>
#include <gtest/gtest.h>

TEST(gate, sort_by_score_already_sorted)
{
    const auto nodes //
        = []()
    {
        std::vector<nil::gate::builder::Node> retval;
        retval.emplace_back( //
            nil::gate::builder::Node{
                .type = 1,
                .inputs = {2},
                .outputs = {3},
                .controls = {4} //
    ...
    const auto result = nil::gate::builder::sort_by_score(nodes);
...
TEST(gate, sort_by_score_reverse_sorted)
{
    const auto nodes //
        = []()
    {
